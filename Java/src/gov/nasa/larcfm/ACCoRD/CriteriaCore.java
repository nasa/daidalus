...
public class CriteriaCore {
	 ...
	 * 
	 * Note:  The string ids are used to break symmetry
	 * 
	 ...
	 *    @param epsh    horizontalCoordination
	 */
	...
	private static boolean vs_bound_crit(Vect3 v, Vect3 nv, int eps) {
		Vect2 v2 = v.vect2();
		boolean rtn;
		if (eps*v.z > 0)
	...
	private static double min_rel_vert_speed(double vz, int eps, double minrelvs) {
		double rtn;
		if (eps*vz <= 0)
			rtn = minrelvs;
		else
